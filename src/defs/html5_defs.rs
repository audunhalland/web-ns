...
pub mod tags {
    ...
    pub struct Void(pub bool);

    pub const DEFS: &[(&str, Void, &'static NS)] = &[
        ("a", Void(false), &HTML5),
        ("abbr", Void(false), &HTML5),
        ("acronym", Void(false), &HTML5),
        ("address", Void(false), &HTML5),
        ("applet", Void(false), &HTML5),
        ("area", Void(true), &HTML5),
        ("article", Void(false), &HTML5),
        ("aside", Void(false), &HTML5),
        ("audio", Void(false), &HTML5),
        ("b", Void(false), &HTML5),
        ("base", Void(true), &HTML5),
        ("basefont", Void(true), &HTML5),
        ("bdi", Void(false), &HTML5),
        ("bdo", Void(false), &HTML5),
        ("bgsound", Void(true), &HTML5),
        ("big", Void(false), &HTML5),
        ("blink", Void(false), &HTML5),
        ("blockquote", Void(false), &HTML5),
        ("body", Void(false), &HTML5),
        ("br", Void(true), &HTML5),
        ("button", Void(false), &HTML5),
        ("canvas", Void(false), &HTML5),
        ("caption", Void(false), &HTML5),
        ("center", Void(false), &HTML5),
        ("cite", Void(false), &HTML5),
        ("code", Void(false), &HTML5),
        ("col", Void(true), &HTML5),
        ("colgroup", Void(false), &HTML5),
        ("command", Void(true), &HTML5),
        ("content", Void(false), &HTML5),
        ("data", Void(false), &HTML5),
        ("datalist", Void(false), &HTML5),
        ("dd", Void(false), &HTML5),
        ("del", Void(false), &HTML5),
        ("details", Void(false), &HTML5),
        ("dfn", Void(false), &HTML5),
        ("dialog", Void(false), &HTML5),
        ("dir", Void(false), &HTML5),
        ("div", Void(false), &HTML5),
        ("dl", Void(false), &HTML5),
        ("dt", Void(false), &HTML5),
        ("element", Void(false), &HTML5),
        ("em", Void(false), &HTML5),
        ("embed", Void(true), &HTML5),
        ("fieldset", Void(false), &HTML5),
        ("figcaption", Void(false), &HTML5),
        ("figure", Void(false), &HTML5),
        ("font", Void(false), &HTML5),
        ("footer", Void(false), &HTML5),
        ("form", Void(false), &HTML5),
        ("frame", Void(true), &HTML5),
        ("frameset", Void(false), &HTML5),
        ("h1", Void(false), &HTML5),
        ("h2", Void(false), &HTML5),
        ("h3", Void(false), &HTML5),
        ("h4", Void(false), &HTML5),
        ("h5", Void(false), &HTML5),
        ("h6", Void(false), &HTML5),
        ("head", Void(false), &HTML5),
        ("header", Void(false), &HTML5),
        ("hgroup", Void(false), &HTML5),
        ("hr", Void(true), &HTML5),
        ("html", Void(false), &HTML5),
        ("i", Void(false), &HTML5),
        ("iframe", Void(false), &HTML5),
        ("image", Void(true), &HTML5),
        ("img", Void(true), &HTML5),
        ("input", Void(true), &HTML5),
        ("ins", Void(false), &HTML5),
        ("isindex", Void(true), &HTML5),
        ("kbd", Void(false), &HTML5),
        ("keygen", Void(true), &HTML5),
        ("label", Void(false), &HTML5),
        ("legend", Void(false), &HTML5),
        ("li", Void(false), &HTML5),
        ("link", Void(true), &HTML5),
        ("listing", Void(false), &HTML5),
        ("main", Void(false), &HTML5),
        ("map", Void(false), &HTML5),
        ("mark", Void(false), &HTML5),
        ("marquee", Void(false), &HTML5),
        ("math", Void(false), &HTML5),
        ("menu", Void(false), &HTML5),
        ("menuitem", Void(true), &HTML5),
        ("meta", Void(true), &HTML5),
        ("meter", Void(false), &HTML5),
        ("multicol", Void(false), &HTML5),
        ("nav", Void(false), &HTML5),
        ("nextid", Void(true), &HTML5),
        ("nobr", Void(false), &HTML5),
        ("noembed", Void(false), &HTML5),
        ("noframes", Void(false), &HTML5),
        ("noscript", Void(false), &HTML5),
        ("object", Void(false), &HTML5),
        ("ol", Void(false), &HTML5),
        ("optgroup", Void(false), &HTML5),
        ("option", Void(false), &HTML5),
        ("output", Void(false), &HTML5),
        ("p", Void(false), &HTML5),
        ("param", Void(true), &HTML5),
        ("picture", Void(false), &HTML5),
        ("plaintext", Void(false), &HTML5),
        ("pre", Void(false), &HTML5),
        ("progress", Void(false), &HTML5),
        ("q", Void(false), &HTML5),
        ("rb", Void(false), &HTML5),
        ("rbc", Void(false), &HTML5),
        ("rp", Void(false), &HTML5),
        ("rt", Void(false), &HTML5),
        ("rtc", Void(false), &HTML5),
        ("ruby", Void(false), &HTML5),
        ("s", Void(false), &HTML5),
        ("samp", Void(false), &HTML5),
        ("script", Void(false), &HTML5),
        ("section", Void(false), &HTML5),
        ("select", Void(false), &HTML5),
        ("shadow", Void(false), &HTML5),
        ("slot", Void(false), &HTML5),
        ("small", Void(false), &HTML5),
        ("source", Void(true), &HTML5),
        ("spacer", Void(false), &HTML5),
        ("span", Void(false), &HTML5),
        ("strike", Void(false), &HTML5),
        ("strong", Void(false), &HTML5),
        ("style", Void(false), &HTML5),
        ("sub", Void(false), &HTML5),
        ("summary", Void(false), &HTML5),
        ("sup", Void(false), &HTML5),
        ("svg", Void(false), &SVG),
        ("table", Void(false), &HTML5),
        ("tbody", Void(false), &HTML5),
        ("td", Void(false), &HTML5),
        ("template", Void(false), &HTML5),
        ("textarea", Void(false), &HTML5),
        ("tfoot", Void(false), &HTML5),
        ("th", Void(false), &HTML5),
        ("thead", Void(false), &HTML5),
        ("time", Void(false), &HTML5),
        ("title", Void(false), &HTML5),
        ("tr", Void(false), &HTML5),
        ("track", Void(true), &HTML5),
        ("tt", Void(false), &HTML5),
        ("u", Void(false), &HTML5),
        ("ul", Void(false), &HTML5),
        ("var", Void(false), &HTML5),
        ("video", Void(false), &HTML5),
        ("wbr", Void(true), &HTML5),
        ("xm", Void(false), &HTML5),
    ];
}
